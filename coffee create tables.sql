...
--Insert the First two Values Into the employees Table
...
--Set the coffeeshop_id for the first two employees to 1
UPDATE employees
SET coffeeshop_id = 1
...
--Insert the first two values where the coffeeshop_id = 1 into the suppliers table
